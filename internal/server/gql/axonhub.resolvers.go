...
func (r *requestResolver) RequestBody(ctx context.Context, obj *ent.Request) (any, error) {
...
func (r *requestResolver) ResponseChunks(ctx context.Context, obj *ent.Request) ([]any, error) {
	...
	if err != nil {
		...
		return nil, fmt.Errorf("failed to load response chunks: %w", err)
	}
...
// RequestBody is the resolver for the requestBody field.
func (r *requestExecutionResolver) RequestBody(ctx context.Context, obj *ent.RequestExecution) (any, error) {
...
// ResponseBody is the resolver for the responseBody field.
func (r *requestExecutionResolver) ResponseBody(ctx context.Context, obj *ent.RequestExecution) (any, error) {
...
// ResponseChunks is the resolver for the responseChunks field.
func (r *requestExecutionResolver) ResponseChunks(ctx context.Context, obj *ent.RequestExecution) ([]any, error) {
