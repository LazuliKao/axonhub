...
function QuotaRow({ channel }: { channel: ProviderQuotaChannel }) {
  ...
  const quotaData = {"plan_type":"plus","rate_limit":{"allowed":true,"limit_reached":false,"primary_window":{"limit_window_seconds":18000,"reset_after_seconds":10000,"reset_at":1776980995,"used_percent":70},"secondary_window":{"limit_window_seconds":604800,"reset_after_seconds":468030,"reset_at":1777407303,"used_percent":10}}} as QuotaData;
